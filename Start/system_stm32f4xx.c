...
/*
AHB=HSE(代码中设置为HSE)*PLL_N/PLL_M/PLL_P，所以AHB为84MHz
*/
...
/*************************************************
这里是配置AHB预分频为1的，HPRE中的H表示AHB，DIV1表示分频1或不分频
*************************************************/	  
    /* HCLK = SYSCLK / 1*/
...
/*************************************************
这里是配置APB1和APB2的，PPRE中的P即指APB，这里配置APB1
为2分频，APB2为1分频，即APB1为42MHz，APB2为84MHz
*************************************************/
